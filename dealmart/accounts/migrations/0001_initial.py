# Generated by Django 2.1.5 on 2019-01-27 19:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('electronics', 'Electronics'), ('mobile', 'Mobile'), ('laptop', 'Laptop'), ('men', 'Men'), ('women', 'Women'), ('kids', 'Kids'), ('groceries', 'Groceries'), ('cosmetics', 'Cosmetics'), ('footwear', 'Footwear'), ('sports', 'Sports'), ('books', 'Books'), ('furnitures', 'Furnitures'), ('decorations', 'Decorations')], max_length=20)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
